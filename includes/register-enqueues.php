	...
	function _1p21_dv_register_scripts_front() {
		...
		if(isset($values['dv_optimize'])){
			...
			wp_register_script( 'd3',null,array(),null,true);
				wp_register_script( '1p21-dv-script-front', null,array('d3'),null,true);
			...
			wp_register_script( 'd3',_1P21_DV_PLUGIN_URL.'assets/d3.v5.min.js',array(),false,true);
				if(current_user_can('administrator')) {
					wp_register_script( '1p21-dv-script-front', _1P21_DV_PLUGIN_URL . 'src/script-front.js',array('d3'),null,true);
				}else{
					wp_register_script( '1p21-dv-script-front', _1P21_DV_PLUGIN_URL . 'assets/script-front.min.js',array('d3'),null,true);
				}
		}
