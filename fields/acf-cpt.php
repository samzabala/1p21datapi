		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					...
					'name' => 'min',
					'type' => 'number',
					'instructions' => 'value of the minimum tick mark.<br>Set as blank if desired first tick mark value is the minimum value in the data<br> to disable tick marks to scale with data updates, setting a value is recommended.',
					'required' => 0,
					'conditional_logic' => array(
						array(
							array(
		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					...
					'name' => 'fill_axis',
					'type' => 'select',
					'instructions' => 'Set which axis to add a fill to. the fill will be added to the side closest to the axis alignment',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '50',
		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					...
					'name' => 'data_format',
					'type' => 'text',
					'instructions' => 'accepts string format or function<br>Reference: <a href="https://github.com/d3/d3-format">https://github.com/d3/d3-format</a><br>Setting this will override Pie Label settings',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
