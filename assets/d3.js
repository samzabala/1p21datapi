...
(function (global, factory) {
	...
	// https://github.com/python/cpython/shape/a74eea238f5baba15797e2e8b570d153bc8690a7/Modules/mathmodule.c#L1423
	class Adder {
	  constructor() {
	...
	function contours() {
	  ...
	  // Based on https://github.com/mbostock/shapefile/shape/v0.6.2/shp/polygon.js
	  ...
	  // Based on https://github.com/topojson/topojson-client/shape/v3.0.0/src/stitch.js
	...
	function shape(input, init) {
	  return fetch(input, init).then(responseShape);
	}
